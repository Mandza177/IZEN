...
user00 = User.create!(first_name: "Adolphe", last_name: "Thiers", email: "adolphe.thiers@gmail.com", password: "azerty", location: "Nantes", result_test: "")
...
p0 = Pratician.create!(first_name: "Yann", last_name: "Lecocq", job: "Hypnose", phone_number: "06.09.82.16.04", email: "yannlecocqhypnose44@gmail.com", address: "62 Bd Jean Ingres 44300 St Herblain", symptom: s0, price: 65, description: "Je m'appelle Yann et je suis spécialisé sur la gestion des émotions. On apprend à se faire confiance. Je vous aide à définir votre objectif et on le valide ensemble. Notre séance d’Hypnose est un voyage entre votre conscient et votre inconscient dans lequel vous êtes le seul au commande de vos pensées. Par le biais de suggestions verbales et visuelles très générales pour vivre votre propre expérience.")

p1 = Pratician.create!(first_name: "Edith", last_name: "Wernert", job: "Hypnose", phone_number: "07.64.48.22.11", email: "edith.werner@gmail.com", address: "62 Bd Jean Ingres 44300 St Herblain", symptom: s1, price: 50, description: "En 2008, passionnée par ce métier, je me suis installée en tant que thérapeute en cabinet. Par la suite, je me suis spécialisée dans l’ARRÊT DU TABAC et l’AMINCISSEMENT. J'anime des formations dans le domaine des THERAPIES ENERGETIQUES (Reiki, Lahotchi…) et d’HYPNOSE (Auto-hypnose, EFT, TIPI, Cohérence Cardiaque, Fleurs de Bach etc…).")

p2 = Pratician.create!(first_name: "Laurence", last_name: "Bobet", job: "Hypnose", phone_number: "07.49.31.25.49", email: "laurence.bobet@gmail.com", address: "62 Bd Jean Ingres 44300 St Herblain", symptom: s2, price: 60, description: "J'exerce depuis 2 ans avec l'Hypnose Sajece. Sous forme d'histoires métahporiques et de sugestions à votre inconscient qui élabore une nouvelle stratégie de changement")

p3 = Pratician.create!(first_name: "Claire", last_name: "Pelletier", job: "Hypnose", phone_number: "06.85.62.14.42", email: "claire.pelletier@gmail.com", address: "62 Bd Jean Ingres 44300 St Herblain", symptom: s3, price: 50, description: "Je m’appelle Claire, J’accompagne maintenant les enfants de façon individuelle dans leurs apprentissages. Formée en psychopédagogie (la Fabrique à Bonheur) et consultante en intégration des réflexes archaïques (méthode RMTi®), je comprends aussi les besoins des enfants à haut potentiel et hyper sensibles.")

p4 = Pratician.create!(first_name: "Gilles", last_name: "Chehade", job: "Hypnose", phone_number: " 07.66.39.73.94", email: "gilles@hypno.cat", address: "62 Bd Jean Ingres 44300 St Herblain", symptom: s4, price: 55, description: "J’ai découvert l’hypnose en 2015 avec beaucoup de curiosité et de scepticisme pour une pratique qui me semblait peu rationnelle. J’ai entrepris de me former pour mieux la comprendre et suis devenu praticien l’année suivante, convaincu que cette pratique était non seulement bien rationnelle mais devait surtout faire partie intégrante de ma vie.")
...
p9 = Pratician.create!(first_name: "François ", last_name: "DE BOISJOLLY", job: "Ostéopathie", phone_number: "02.40.48.72.00", email: "frdeboisjolly@wanadoo.fr", address: "Cabinet d'Ostéopathie Monselet 12, rue de Carcouët", symptom: s9, price: 70, description: "Le cabinet d'Ostéopathie Monselet assure les prises en charge des bébés, adolescents, adultes, personnes âgées, handicapés, sportifs, femmes enceintes...La prise de rendez-vous peut se faire sur DOCTOLIB.fr.Prendre rendez-vous en ligne")
...
p13 = Pratician.create!(first_name: "Claire", last_name: "Morosini", job: "Chiropratique", phone_number: "06.17.38.42.04", email: "morosini.chiro@gmail.com", address: "7 rue de la Jaunais Montoir-de-Bretagne (44550)", symptom: s2, price: 50, description: "J’ai choisi d’étudier la chiropraxie car j’aime la façon de voir le corps humain dans sa globalité. La chiropraxie me permet de rechercher la cause du problème. Tous les jours sont différents car tous les êtres humains sont différents, et il faut savoir s’adapter. J’ai toujours été attirée par le fait d’aider les gens et cette profession me le permet.")

p14 = Pratician.create!(first_name: "Manon ", last_name: "CHAIGNEAU", job: "Chiropratique", phone_number: "07 87 74 30 00", email: "mchaigneau.chiropraxie@gmail.com", address: " 3 avenue Gustave Lusseaud Saint-Brevin-les-Pins (44250)", symptom: s3, price: 70, description: "Mon envie de prendre soin des autres et de connaître l’étendue des capacités du corps humain m’ont poussé à faire des études de chiropraxie. Etre intégrée dans le parcours de soin d’une personne pour améliorer sa qualité de vie.")

p15 = Pratician.create!(first_name: "Laetitia", last_name: "Machard", job: "Naturopathie", phone_number: "06.29.59.88.27", email: "http://laetitiamachard.site-solocal.com", address: "1 rue Bons Français 44000 Nantes ", symptom: s4, price: 75, description: "En une ou deux séances, apprenez à mieux vous connaître et gagnez en vitalité et en joie de vivre grâce à la naturopathie.Quelque soit votre demande, je prendrai le temps d'y répondre avec le plus grand soin.")

p16 = Pratician.create!(first_name: "Bénédicte", last_name: "GIE", job: "Naturopathie", phone_number: "06.17.98.26.06", email: "benedictegie@yahoo.fr", address: " Cabinet Saint Jacques 13 boulevard Joliot Curie 44200 Nantes", symptom: s4, price: 80, description: "Une consultation c'est une capacité d'écoute, des échanges constructifs, une évaluation globale et individualisée de votre santé. Je vous conseille sur les bonnes pratiques   (alimentation, nutrition, chronobiologie, techniques de relaxation...)")

p17 = Pratician.create!(first_name: "Eric", last_name: "Blasin", job: "Naturopathie", phone_number: "02.40.76.74.64", email: "http://www.naturopathe-iridologue.com", address: " 99 boulevard Anglais 44100 Nantes", symptom: s5, price: 70, description: "Eric Blasin, naturopathe Nantes, iridologue et auriculothérapeute propose un autre regard sur la santé et le bien être dans le quartier Procès à Nantes.Ces différentes techniques vous sont proposées : Naturopathie, iridologie, auriculothérapie, thérapie quantique, Miltaled, Physioscan, conseil en diététique et hygiène de vie, oligo-éléments, fleurs de Bach, huiles essentielles, micronutrition et phytothérapie.")

p18 = Pratician.create!(first_name: "Nathalie", last_name: "Juillard", job: "Naturopathie", phone_number: "06.85.57.21.66", email: "http://www.nathaliejuillard.com", address: "49 rue Gourmette 44300 Nantes", symptom: s6, price: 80, description: "Depuis toujours j’ai une sensibilité à la médecine naturelle et à la spiritualité.Plutôt, j’ai débuté dans la vie active en travaillant en entreprises dans le secteur du commerce, j’aime le contact avec l’humain et il me manquait quelque chose qui est plus de sens pour moi. Il me manquait plus de profondeur et d’un véritable intérêt à œuvrer, moi qui suis toujours en quête de sens.")

p19 = Pratician.create!(first_name: "Aurélie", last_name: "Pereira", job: "Naturopathie", phone_number: "06.79.28.55.07", email: "http://www.lalyreikienergies.com", address: "rue Pays de la Loire 44300 Nantes", symptom: s7, price: 65, description: "Maître Enseignante et Praticienne Reiki Usui, Prêtresse d’Isis, formatrice, naturopathe certifiée et magnétiseuse depuis toujours, je suis une louve, une guerrière de lumière, une (bonne) sorcière, je t’accompagne, t’aide, t’écoute, te transmets mon savoir et mes énergies…")

p20 = Pratician.create!(first_name: "Jordane", last_name: "Saunal", job: "Sonothérapie", phone_number: "06.85.85.44.64", email: "http://jordanesaunal-sonotherapie.com", address: "52 avenue Parc de Procé 44100 Nantes", symptom: s8, price: 60, description: "Dans mon approche de la sonothérapie je donne une grande place à l’écoute de mon intuition, aux ressentis énergétiques qui me servent de guides. J’utilise, lors des séances, des instruments qui me sont chers tels que les bols tibétains, bols chantants, gong, carillons")

p21 = Pratician.create!(first_name: "Marielle", last_name: "PICART", job: "Sonothérapie", phone_number: "06.82.51.56.58", email: "http://mariellepicart-kinesiologie.com/", address: "24 rue Noire 44000 Nantes", symptom: s9, price: 50, description: "Et s’il était possible d’établir un dialogue avec le corps pour identifier les sources inconscientes de nos déséquilibres. C'est une pratique de communication subtile et directe avec le corps, lui permettant d’initier des changements pour un mieux-être intérieur.")

p22 = Pratician.create!(first_name: "Manuel", last_name: "Mahe", job: "Sonothérapie", phone_number: "06.17.98.26.06", email: "https://www.medoucine.com/consultation/nantes/benedicte-gie/2977?utm_source=bouton-rdv&utm_medium=pack-com&utm_campaign=benedicte-gie", address: " Cabinet Saint Jacques 13 boulevard Joliot Curie 44200 Nantes", symptom: s10, price: 55, description: "Convaincu par notre pouvoir d’auto-guérison, je propose des relaxations sonores, des méditations guidées par les sons, des voyages dans l’inconscient avec le Yoga Nidra, des soins sonores et énergétiques pour ouvrir chez chacun un espace de créativité et de guérison en reliance avec ses forces et de son guide Intérieur.")
