...
p10 = Pratician.create!(first_name: "Gwénaëlle", last_name: "De Buor", job: "Chiropracteur", phone_number: "06.23.92.73.23", email: "gwenaelledebuor@yahoo.fr", address: " 47 rue Littré 44100 Nantes", symptom: s10, description: "Gwénaëlle de Buor est Chiropracteur Diplômé,Son cabinet accueille les adultes, les femmes enceintes, les nourrissons, les enfants, les sportifs, les personnes âgées...Les motifs de consultation sont divers :mal de dos, sciatiques, cruralgie, migraines, maux de tête")

p11 = Pratician.create!(first_name: "Guillaume", last_name: "Martin", job: "Chiropracteur", phone_number: "09.67.01.02.52", email: "Martinguillaume@yahoo.com", address: "7 boulevard des sports Vertou (44120)", symptom: s0, description: "Présentation.La chiropraxie est une thérapie manuelle pour les soins du dos et des articulations. Elle a pour objet la détection, le traitement et la prévention des dysfonctionnements du squelette et de ses conséquences, notamment au niveau de l'appareil locomoteur. Ces dysfonctions se traduisent notamment par des douleurs ou une limitation du mouvement.")

p12 = Pratician.create!(first_name: "Linda", last_name: "Moie Meurou", job: "Chiropracteur", phone_number: "02 40 45 34 76", email: "lindamoie@gmail.com", address: "8, rue du milan noir Z.A. Brehadour Guérande (44350)", symptom: s1, description: "Elle reçoit enfants, nourrissons, musiciens, personnes sédentaires, sportifs, personnes actives.La chiropraxie, également appelée méthode chiropratique ou pratique chiropratique, est une méthode de référence pour traiter les problèmes de dos ou d'articulations.")

p13 = Pratician.create!(first_name: "Claire", last_name: "Morosini", job: "Chiropracteur", phone_number: "06.17.38.42.04", email: "morosini.chiro@gmail.com", address: "7 rue de la Jaunais Montoir-de-Bretagne (44550)", symptom: s2, description: "J’ai choisi d’étudier la chiropraxie car j’aime la façon de voir le corps humain dans sa globalité. La chiropraxie me permet de rechercher la cause du problème. Tous les jours sont différents car tous les êtres humains sont différents, et il faut savoir s’adapter. J’ai toujours été attirée par le fait d’aider les gens et cette profession me le permet.")

p14 = Pratician.create!(first_name: "Manon ", last_name: "CHAIGNEAU", job: "Chiropracteur", phone_number: "07 87 74 30 00", email: "mchaigneau.chiropraxie@gmail.com", address: " 3 avenue Gustave Lusseaud Saint-Brevin-les-Pins (44250)", symptom: s3, description: "Mon envie de prendre soin des autres et de connaître l’étendue des capacités du corps humain m’ont poussé à faire des études de chiropraxie.Etre intégrée dans le parcours de soin d’une personne pour améliorer sa qualité de vie")
